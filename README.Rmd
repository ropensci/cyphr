...
* Encrypt and decrypt strings (`encrypt_string` / `decrypt_string`), objects (`encrypt_object` / `decrypt_object`), raw data (`encrypt_data` / `decrypt_data`) and files (`encrypt_file` / `decrypt_file`)
